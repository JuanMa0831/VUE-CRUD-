<template>
    ...
    <input type="text" class="form-control" id="comu_nomb" placeholder="Código comuna" v-model='comuna.comu_nomb'
    >
    </div>
    </div>
...
<div class="input-group">
<div class="input-group-text"> <font-awesome-icon icon="bank" /></div> <select class="form-select" v-model="comuna.muni_codi">
<option v-for="municipio in municipios" v-bind:value="municipio.muni codi">{{ municipio. muni_nomb }}</option> </select>
</div>
</div>
